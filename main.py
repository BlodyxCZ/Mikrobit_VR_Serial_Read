...
while True:
    try:
        ...
        if data[:1] == "G":
            ...
            if len(data) != 11:
                break
            json_data = {"raw": data[0], "pitch": data[1], "rotation": data[2], "vel_x": data[3], "vel_z": data[4],
                         "A": strtobool(data[5]), "B": strtobool(data[6]), "C": strtobool(data[7]),
                         "D": strtobool(data[8]), "E": strtobool(data[9]), "F": strtobool(data[10])}
